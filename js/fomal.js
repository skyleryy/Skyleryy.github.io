...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | Jerraon🥝")[0];
}
  ...
  (function ($) {
    $.fn.nekoScroll = function (option) {
      var defaultSetting = {
        ...
        borderRadius: 5 + 'px',
        right: 55.6 + 'px',
        nekoImg: "https://s1.vika.cn/space/2023/01/12/de6bdeba1f1843ae9d8fef278ee944b8",
        hoverMsg: "到底啦~",
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Jerraon🥝 %c 你正在访问JerraonのYuan的小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Jerraon") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Jerraon的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://s1.vika.cn/space/2023/01/11/744c2a66be354231812787633115f8c7);
    --darkmode-bg:url(https://s1.vika.cn/space/2023/01/16/eb64769f6986483fa2e10616ec2ab9a7);
    --mobileday-bg: url(https://s1.vika.cn/space/2023/01/11/744c2a66be354231812787633115f8c7);
    --mobilenight-bg: url(https://s1.vika.cn/space/2023/01/16/eb64769f6986483fa2e10616ec2ab9a7);
  }`;
}
// 切换背景主函数
function changeBg(s) {
